...
declare module 'corbel-js' {
 ...
 class CommonUserBuilder extends Services{
 ...
 class UserBuilder extends CommonUserBuilder {
 ...
 class UserMeBuilder extends CommonUserBuilder {
 ...
 class UsersBuilder extends Services{
    uri: string;
 ...
 export class Collection extends BaseResource {
  ...
  export class Relation extends BaseResource {
